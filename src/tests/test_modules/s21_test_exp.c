...
/// @brief exp(0.0001312) = -8.938788 \f]
...
/// @brief exp(0.0001624) = -8.725448 \f]
...
/// @brief exp(0.0001936) = -8.549716 \f]
...
/// @brief exp(0.0002248) = -8.400299 \f]
...
/// @brief exp(0.0002560) = -8.270333 \f]
...
/// @brief exp(0.0002872) = -8.155332 \f]
...
/// @brief exp(0.0003184) = -8.052202 \f]
...
/// @brief exp(0.0003496) = -7.958721 \f]
...
/// @brief exp(0.0003808) = -7.873236 \f]
...
/// @brief exp(0.0004120) = -7.794487 \f]
...
/// @brief exp(0.0004432) = -7.721489 \f]
...
/// @brief exp(0.0004744) = -7.653460 \f]
...
/// @brief exp(0.0005056) = -7.589765 \f]
...
/// @brief exp(0.0005368) = -7.529885 \f]
...
/// @brief exp(0.0005680) = -7.473389 \f]
...
/// @brief exp(0.0005992) = -7.419915 \f]
...
/// @brief exp(0.0006304) = -7.369156 \f]
...
/// @brief exp(0.0006616) = -7.320849 \f]
...
/// @brief exp(0.0006928) = -7.274769 \f]
...
/// @brief exp(0.0007240) = -7.230719 \f]
...
/// @brief exp(0.0007552) = -7.188528 \f]
...
/// @brief exp(0.0007864) = -7.148045 \f]
...
/// @brief exp(0.0008176) = -7.109137 \f]
...
/// @brief exp(0.0008488) = -7.071687 \f]
...
/// @brief exp(0.0008800) = -7.035589 \f]
...
/// @brief exp(0.0009112) = -7.000748 \f]
...
/// @brief exp(0.0009424) = -6.967081 \f]
...
/// @brief exp(0.0009736) = -6.934510 \f]
...
/// @brief exp(0.0010048) = -6.902967 \f]
...
/// @brief exp(0.0010360) = -6.872388 \f]
...
/// @brief exp(0.0010672) = -6.842717 \f]
...
/// @brief exp(0.0010984) = -6.813901 \f]
...
/// @brief exp(0.0011296) = -6.785892 \f]
...
/// @brief exp(0.0011608) = -6.758646 \f]
...
/// @brief exp(0.0011920) = -6.732123 \f]
...
/// @brief exp(0.0012232) = -6.706285 \f]
...
/// @brief exp(0.0012544) = -6.681098 \f]
...
/// @brief exp(0.0012856) = -6.656530 \f]
...
/// @brief exp(0.0013168) = -6.632551 \f]
...
/// @brief exp(0.0013480) = -6.609133 \f]
...
/// @brief exp(0.0013792) = -6.586252 \f]
...
/// @brief exp(0.0014104) = -6.563882 \f]
...
/// @brief exp(0.0014416) = -6.542002 \f]
...
/// @brief exp(0.0014728) = -6.520590 \f]
...
/// @brief exp(0.0015040) = -6.499627 \f]
...
/// @brief exp(0.0015352) = -6.479095 \f]
...
/// @brief exp(0.0015664) = -6.458975 \f]
...
/// @brief exp(0.0015976) = -6.439253 \f]
...
/// @brief exp(0.0016288) = -6.419912 \f]
...
/// @brief exp(0.0016600) = -6.400938 \f]
...
/// @brief exp(0.0016912) = -6.382317 \f]
...
/// @brief exp(0.0017224) = -6.364037 \f]
...
/// @brief exp(0.0017536) = -6.346084 \f]
...
/// @brief exp(0.0017848) = -6.328449 \f]
...
/// @brief exp(0.0018160) = -6.311119 \f]
...
/// @brief exp(0.0018472) = -6.294084 \f]
...
/// @brief exp(0.0018784) = -6.277335 \f]
...
/// @brief exp(0.0019096) = -6.260861 \f]
...
/// @brief exp(0.0019408) = -6.244655 \f]
...
/// @brief exp(0.0019720) = -6.228707 \f]
...
/// @brief exp(0.0020032) = -6.213009 \f]
...
/// @brief exp(0.0020344) = -6.197554 \f]
...
/// @brief exp(0.0020656) = -6.182335 \f]
...
/// @brief exp(0.0020968) = -6.167343 \f]
...
/// @brief exp(0.0021280) = -6.152573 \f]
...
/// @brief exp(0.0021592) = -6.138017 \f]
...
/// @brief exp(0.0021904) = -6.123671 \f]
...
/// @brief exp(0.0022216) = -6.109528 \f]
...
/// @brief exp(0.0022528) = -6.095581 \f]
...
/// @brief exp(0.0022840) = -6.081827 \f]
...
/// @brief exp(0.0023152) = -6.068259 \f]
...
/// @brief exp(0.0023464) = -6.054873 \f]
...
/// @brief exp(0.0023776) = -6.041664 \f]
...
/// @brief exp(0.0024088) = -6.028627 \f]
...
/// @brief exp(0.0024400) = -6.015757 \f]
...
/// @brief exp(0.0024712) = -6.003051 \f]
...
/// @brief exp(0.0025024) = -5.990505 \f]
...
/// @brief exp(0.0025336) = -5.978114 \f]
...
/// @brief exp(0.0025648) = -5.965875 \f]
...
/// @brief exp(0.0025960) = -5.953783 \f]
...
/// @brief exp(0.0026272) = -5.941837 \f]
...
/// @brief exp(0.0026584) = -5.930031 \f]
...
/// @brief exp(0.0026896) = -5.918363 \f]
...
/// @brief exp(0.0027208) = -5.906829 \f]
...
/// @brief exp(0.0027520) = -5.895427 \f]
...
/// @brief exp(0.0027832) = -5.884154 \f]
...
/// @brief exp(0.0028144) = -5.873006 \f]
...
/// @brief exp(0.0028456) = -5.861981 \f]
...
/// @brief exp(0.0028768) = -5.851077 \f]
...
/// @brief exp(0.0029080) = -5.840290 \f]
...
/// @brief exp(0.0029392) = -5.829618 \f]
...
/// @brief exp(0.0029704) = -5.819059 \f]
...
/// @brief exp(0.0030016) = -5.808610 \f]
...
/// @brief exp(0.0030328) = -5.798269 \f]
...
/// @brief exp(0.0030640) = -5.788034 \f]
...
/// @brief exp(0.0030952) = -5.777903 \f]
...
/// @brief exp(0.0031264) = -5.767873 \f]
...
/// @brief exp(0.0031576) = -5.757943 \f]
...
/// @brief exp(0.0031888) = -5.748111 \f]
...
/// @brief exp(0.0002312) = -8.372227 \f]
...
/// @brief exp(0.0002624) = -8.245641 \f]
...
/// @brief exp(0.0002936) = -8.133292 \f]
...
/// @brief exp(0.0003248) = -8.032301 \f]
...
/// @brief exp(0.0003560) = -7.940580 \f]
...
/// @brief exp(0.0003872) = -7.856569 \f]
...
/// @brief exp(0.0004184) = -7.779073 \f]
...
/// @brief exp(0.0004496) = -7.707152 \f]
...
/// @brief exp(0.0004808) = -7.640059 \f]
...
/// @brief exp(0.0005120) = -7.577186 \f]
...
/// @brief exp(0.0005432) = -7.518033 \f]
...
/// @brief exp(0.0005744) = -7.462185 \f]
...
/// @brief exp(0.0006056) = -7.409291 \f]
...
/// @brief exp(0.0006368) = -7.359055 \f]
...
/// @brief exp(0.0006680) = -7.311222 \f]
...
/// @brief exp(0.0006992) = -7.265574 \f]
...
/// @brief exp(0.0007304) = -7.221918 \f]
...
/// @brief exp(0.0007616) = -7.180089 \f]
...
/// @brief exp(0.0007928) = -7.139940 \f]
...
/// @brief exp(0.0008240) = -7.101340 \f]
...
/// @brief exp(0.0008552) = -7.064175 \f]
...
/// @brief exp(0.0008864) = -7.028342 \f]
...
/// @brief exp(0.0009176) = -6.993749 \f]
...
/// @brief exp(0.0009488) = -6.960313 \f]
...
/// @brief exp(0.0009800) = -6.927958 \f]
...
/// @brief exp(0.0010112) = -6.896618 \f]
...
/// @brief exp(0.0010424) = -6.866230 \f]
...
/// @brief exp(0.0010736) = -6.836738 \f]
...
/// @brief exp(0.0011048) = -6.808091 \f]
...
/// @brief exp(0.0011360) = -6.780242 \f]
...
/// @brief exp(0.0011672) = -6.753148 \f]
...
/// @brief exp(0.0011984) = -6.726768 \f]
...
/// @brief exp(0.0012296) = -6.701066 \f]
...
/// @brief exp(0.0012608) = -6.676009 \f]
...
/// @brief exp(0.0012920) = -6.651564 \f]
...
/// @brief exp(0.0013232) = -6.627702 \f]
...
/// @brief exp(0.0013544) = -6.604397 \f]
...
/// @brief exp(0.0013856) = -6.581622 \f]
...
/// @brief exp(0.0014168) = -6.559354 \f]
...
/// @brief exp(0.0014480) = -6.537572 \f]
...
/// @brief exp(0.0014792) = -6.516254 \f]
...
/// @brief exp(0.0015104) = -6.495381 \f]
...
/// @brief exp(0.0015416) = -6.474934 \f]
...
/// @brief exp(0.0015728) = -6.454898 \f]
...
/// @brief exp(0.0016040) = -6.435255 \f]
...
/// @brief exp(0.0016352) = -6.415990 \f]
...
/// @brief exp(0.0016664) = -6.397090 \f]
...
/// @brief exp(0.0016976) = -6.378540 \f]
...
/// @brief exp(0.0017288) = -6.360328 \f]
...
/// @brief exp(0.0017600) = -6.342441 \f]
...
/// @brief exp(0.0017912) = -6.324869 \f]
...
/// @brief exp(0.0018224) = -6.307601 \f]
...
/// @brief exp(0.0018536) = -6.290626 \f]
...
/// @brief exp(0.0018848) = -6.273934 \f]
...
/// @brief exp(0.0019160) = -6.257516 \f]
...
/// @brief exp(0.0019472) = -6.241363 \f]
...
/// @brief exp(0.0019784) = -6.225467 \f]
...
/// @brief exp(0.0020096) = -6.209820 \f]
...
/// @brief exp(0.0020408) = -6.194413 \f]
...
/// @brief exp(0.0020720) = -6.179241 \f]
...
/// @brief exp(0.0021032) = -6.164295 \f]
...
/// @brief exp(0.0021344) = -6.149570 \f]
...
/// @brief exp(0.0021656) = -6.135058 \f]
...
/// @brief exp(0.0021968) = -6.120754 \f]
...
/// @brief exp(0.0022280) = -6.106651 \f]
...
/// @brief exp(0.0022592) = -6.092745 \f]
...
/// @brief exp(0.0022904) = -6.079029 \f]
...
/// @brief exp(0.0023216) = -6.065499 \f]
...
/// @brief exp(0.0023528) = -6.052149 \f]
...
/// @brief exp(0.0023840) = -6.038976 \f]
...
/// @brief exp(0.0024152) = -6.025973 \f]
...
/// @brief exp(0.0024464) = -6.013138 \f]
...
/// @brief exp(0.0024776) = -6.000465 \f]
...
/// @brief exp(0.0025088) = -5.987951 \f]
...
/// @brief exp(0.0025400) = -5.975591 \f]
...
/// @brief exp(0.0025712) = -5.963383 \f]
...
/// @brief exp(0.0026024) = -5.951321 \f]
...
/// @brief exp(0.0026336) = -5.939404 \f]
...
/// @brief exp(0.0026648) = -5.927626 \f]
...
/// @brief exp(0.0026960) = -5.915986 \f]
...
/// @brief exp(0.0027272) = -5.904480 \f]
...
/// @brief exp(0.0027584) = -5.893104 \f]
...
/// @brief exp(0.0027896) = -5.881857 \f]
...
/// @brief exp(0.0028208) = -5.870735 \f]
...
/// @brief exp(0.0028520) = -5.859735 \f]
...
/// @brief exp(0.0028832) = -5.848854 \f]
...
/// @brief exp(0.0029144) = -5.838091 \f]
...
/// @brief exp(0.0029456) = -5.827443 \f]
...
/// @brief exp(0.0029768) = -5.816906 \f]
...
/// @brief exp(0.0030080) = -5.806480 \f]
...
/// @brief exp(0.0030392) = -5.796161 \f]
...
/// @brief exp(0.0030704) = -5.785947 \f]
...
/// @brief exp(0.0031016) = -5.775837 \f]
...
/// @brief exp(0.0031328) = -5.765828 \f]
...
/// @brief exp(0.0031640) = -5.755918 \f]
...
/// @brief exp(0.0031952) = -5.746106 \f]
...
/// @brief exp(0.0032264) = -5.736388 \f]
...
/// @brief exp(0.0032576) = -5.726765 \f]
...
/// @brief exp(0.0032888) = -5.717233 \f]
...
/// @brief exp(0.0030211) = -5.802134 \f]
...
/// @brief exp(0.0030422) = -5.795174 \f]
...
/// @brief exp(0.0030633) = -5.788263 \f]
...
/// @brief exp(0.0030844) = -5.781398 \f]
...
/// @brief exp(0.0031055) = -5.774581 \f]
...
/// @brief exp(0.0031266) = -5.767809 \f]
...
/// @brief exp(0.0031477) = -5.761083 \f]
...
/// @brief exp(0.0031688) = -5.754402 \f]
...
/// @brief exp(0.0031899) = -5.747766 \f]
...
/// @brief exp(0.0032110) = -5.741173 \f]
...
/// @brief exp(0.0032321) = -5.734623 \f]
...
/// @brief exp(0.0032532) = -5.728116 \f]
...
/// @brief exp(0.0032743) = -5.721651 \f]
...
/// @brief exp(0.0032954) = -5.715228 \f]
...
/// @brief exp(0.0033165) = -5.708845 \f]
...
/// @brief exp(0.0033376) = -5.702503 \f]
...
/// @brief exp(0.0033587) = -5.696201 \f]
...
/// @brief exp(0.0033798) = -5.689939 \f]
...
/// @brief exp(0.0034009) = -5.683715 \f]
...
/// @brief exp(0.0034220) = -5.677530 \f]
...
/// @brief exp(0.0034431) = -5.671383 \f]
...
/// @brief exp(0.0034642) = -5.665274 \f]
...
/// @brief exp(0.0034853) = -5.659201 \f]
...
/// @brief exp(0.0035064) = -5.653165 \f]
...
/// @brief exp(0.0035275) = -5.647166 \f]
...
/// @brief exp(0.0035486) = -5.641202 \f]
...
/// @brief exp(0.0035697) = -5.635274 \f]
...
/// @brief exp(0.0035908) = -5.629380 \f]
...
/// @brief exp(0.0036119) = -5.623521 \f]
...
/// @brief exp(0.0036330) = -5.617697 \f]
...
/// @brief exp(0.0036541) = -5.611905 \f]
...
/// @brief exp(0.0036752) = -5.606148 \f]
...
/// @brief exp(0.0036963) = -5.600423 \f]
...
/// @brief exp(0.0037174) = -5.594731 \f]
...
/// @brief exp(0.0037385) = -5.589071 \f]
...
/// @brief exp(0.0037596) = -5.583443 \f]
...
/// @brief exp(0.0037807) = -5.577846 \f]
...
/// @brief exp(0.0038018) = -5.572281 \f]
...
/// @brief exp(0.0038229) = -5.566746 \f]
...
/// @brief exp(0.0038440) = -5.561242 \f]
...
/// @brief exp(0.0038651) = -5.555768 \f]
...
/// @brief exp(0.0038862) = -5.550323 \f]
...
/// @brief exp(0.0039073) = -5.544909 \f]
...
/// @brief exp(0.0039284) = -5.539523 \f]
...
/// @brief exp(0.0039495) = -5.534166 \f]
...
/// @brief exp(0.0039706) = -5.528838 \f]
...
/// @brief exp(0.0039917) = -5.523538 \f]
...
/// @brief exp(0.0040128) = -5.518266 \f]
...
/// @brief exp(0.0040339) = -5.513022 \f]
...
/// @brief exp(0.0040550) = -5.507805 \f]
...
/// @brief exp(0.0040761) = -5.502615 \f]
...
/// @brief exp(0.0040972) = -5.497451 \f]
...
/// @brief exp(0.0041183) = -5.492315 \f]
...
/// @brief exp(0.0041394) = -5.487204 \f]
...
/// @brief exp(0.0041605) = -5.482120 \f]
...
/// @brief exp(0.0041816) = -5.477061 \f]
...
/// @brief exp(0.0042027) = -5.472028 \f]
...
/// @brief exp(0.0042238) = -5.467020 \f]
...
/// @brief exp(0.0042449) = -5.462037 \f]
...
/// @brief exp(0.0042660) = -5.457079 \f]
...
/// @brief exp(0.0042871) = -5.452145 \f]
...
/// @brief exp(0.0043082) = -5.447235 \f]
...
/// @brief exp(0.0043293) = -5.442349 \f]
...
/// @brief exp(0.0043504) = -5.437487 \f]
...
/// @brief exp(0.0043715) = -5.432649 \f]
...
/// @brief exp(0.0043926) = -5.427834 \f]
...
/// @brief exp(0.0044137) = -5.423042 \f]
...
/// @brief exp(0.0044348) = -5.418273 \f]
...
/// @brief exp(0.0044559) = -5.413526 \f]
...
/// @brief exp(0.0044770) = -5.408802 \f]
...
/// @brief exp(0.0044981) = -5.404100 \f]
...
/// @brief exp(0.0045192) = -5.399420 \f]
...
/// @brief exp(0.0045403) = -5.394762 \f]
...
/// @brief exp(0.0045614) = -5.390126 \f]
...
/// @brief exp(0.0045825) = -5.385511 \f]
...
/// @brief exp(0.0046036) = -5.380917 \f]
...
/// @brief exp(0.0046247) = -5.376344 \f]
...
/// @brief exp(0.0046458) = -5.371792 \f]
...
/// @brief exp(0.0046669) = -5.367260 \f]
...
/// @brief exp(0.0046880) = -5.362749 \f]
...
/// @brief exp(0.0047091) = -5.358258 \f]
...
/// @brief exp(0.0047302) = -5.353788 \f]
...
/// @brief exp(0.0047513) = -5.349337 \f]
...
/// @brief exp(0.0047724) = -5.344906 \f]
...
/// @brief exp(0.0047935) = -5.340494 \f]
...
/// @brief exp(0.0048146) = -5.336102 \f]
...
/// @brief exp(0.0048357) = -5.331729 \f]
...
/// @brief exp(0.0048568) = -5.327375 \f]
...
/// @brief exp(0.0048779) = -5.323040 \f]
...
/// @brief exp(0.0048990) = -5.318724 \f]
...
/// @brief exp(0.0049201) = -5.314426 \f]
...
/// @brief exp(0.0049412) = -5.310147 \f]
...
/// @brief exp(0.0049623) = -5.305886 \f]
...
/// @brief exp(0.0049834) = -5.301643 \f]
...
/// @brief exp(0.0050045) = -5.297418 \f]
...
/// @brief exp(0.0050256) = -5.293210 \f]
...
/// @brief exp(0.0050467) = -5.289021 \f]
...
/// @brief exp(0.0050678) = -5.284848 \f]
...
/// @brief exp(0.0050889) = -5.280694 \f]
