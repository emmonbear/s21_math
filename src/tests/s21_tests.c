...
int main(void) {
  ...
  Suite *(*s21_fabs[])(void) = {
      ...
      s21_fabs_seventh_case, s21_fabs_eighth_case, s21_fabs_ninth_case,
      s21_fabs_tenth_case,   s21_fabs_edge_case,
  };
  ...
  Suite *(*s21_ceil[])(void) = {
      ...
      s21_ceil_seventh_case, s21_ceil_eighth_case, s21_ceil_ninth_case,
      s21_ceil_tenth_case,   s21_ceil_edge_case,
  };
